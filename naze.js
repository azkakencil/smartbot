...
/*
	* Create By Smartgadget
	* Follow https://github.com/azkakencil
	* Whatsapp : https://chat.whatsapp.com/J6DuaTIwo2wEjSn7TEEFv1
*/
...
const naze = async (naze, m, msg, store) => {
	...
	try {
		...
		const author = set.author = global.author || 'SmartGadget';
		...
		switch(fileSha256 || command) {
			...
			break
			case 'sc': case 'script': {
				await m.reply(`https://github.com/azkakencil/smartbot\n⬆️ Itu Sc nya cuy`, {
					contextInfo: {
						forwardingScore: 10,
						isForwarded: true,
